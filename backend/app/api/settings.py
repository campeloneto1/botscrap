...
async def get_settings(
    ...
    return AppSettingsResponse(
        ...
        twitter_password=mask_sensitive(settings.twitter_password),
        facebook_email=settings.facebook_email,
        facebook_password=mask_sensitive(settings.facebook_password),
